...
Provided in the project is a bash script for downloading and unzipping the Grocery and Gourmet Foods subset of the Amazon data. Go ahead and run the following:
```
```
...
```
automaton@ip-10-200-177-27:~/kafka_to_sparkstreaming_to_graph$ cat resources/schema/AmazonDSEMaterializedCustomID.groovy | dse gremlin-console
